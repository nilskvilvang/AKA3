...
Beste modell kan dermed forklare 79.6 % av variansen i den avhengige variabelen.
...
Beste modell kan dermed forklare 80.5 % av variansen i den avhengige variabelen.
...
print(rsq4)
#>                  R-squared
#> Ridge regression 0.7959213
#> Lasso regression 0.8047073
#> Elastic-net      0.8007032
```
