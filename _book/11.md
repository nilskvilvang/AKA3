...
Beste modell kan dermed forklare 79.2 % av variansen i den avhengige variabelen.
...
Beste modell kan dermed forklare 80.3 % av variansen i den avhengige variabelen.
...
print(rsq4)
#>                  R-squared
#> Ridge regression 0.7921595
#> Lasso regression 0.8043195
#> Elastic-net      0.8030335
```
