...
Et annet forhold vi kan legge merke til er at confusion matrix gir oss type I og type II feil (jfr diskusjon i kapittel 2 om disse feiltypene). Antallet type I feil (som da er type I feil) er `r cm2[3]` og antall type II feil er `r cm2[4]`. Modellen vår har i dette tilfellet en presisjon på `r round((cm2[1] + cm2[2])/(cm2[1] + cm2[2] + cm2[3] + cm2[4]), 2)` og en feilrate på `r round((cm2[3] + cm2[4])/(cm2[1] + cm2[2] + cm2[3] + cm2[4]), 2)`.
...
Fortsatt litt kludrete når vi skal regne ut "likelihood". Dette er altså sannsynligheten for at en person som tar bussen har egenskap x. Men her bruker vi bare samme plott som ovenfor og finner hvor mange innenfor sirkelen som tar buss og ser det i forhold til hvor mange som tar buss totalt, og får:
