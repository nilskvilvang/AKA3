...
```{r}
pacman::p_load(tidyverse, AmesHousing, outliers, EnvStats, caTools, Metrics, psych, tdr, readxl, e1071, caret, plotly, rpart, rpart.plot, knitr, hydroGOF, ggridges, tidymodels, sf, patchwork, RColorBrewer, grid, ragg, ipred, rattle, randomForest, glmnet, datasets, plotrix, ggforce) 
```
...
Vi kan da gå videre med å trene en logistisk regresjon på treningsdataene.

```{r}
klassifisering <- glm(Kjop ~ .,
                      family = binomial,
...
Denne tabellen kan vi lese som følger: Der verdiene er 0-0 og 1-1 (hhv. 57 og 9) predikerer modellen vår riktig. Og i motsatt diagonal - verdiene 3 og 6) har modellen vår predikert feil. Modellen vår har altså predikert 66 av 75 riktig, og følgelig 9 av 75 feil. Vi kan se på to mål på hvor bra dette er.
...
Spesifitet (= "True negative rate") er den prosentvise korrekt predikerte andelen av samsvar mellom predikerte 0-verdier og faktiske 0-verdier.
