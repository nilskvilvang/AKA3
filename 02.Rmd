...
set.seed(30)
x <- rnorm(100, 179, 16)
hist(x, xlab = "Hoyde", ylab = "Antall", main = "Histogram for genererte hoydedata")
```
...
hist(data, xlab = "Hoyde", ylab = "Antall", main = "Histogram for genererte hoydedata")
```
