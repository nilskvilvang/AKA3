...
```{r echo = FALSE, caption = "Eksempel på beskrivende modell (LOESS) - data fra 'mtcars'"}
...
p4 <- ggplot(normalfordeling, aes(x)) + 
    ...
    stat_function(fun = dnorm, args = list(mean=mean(normalfordeling$x),
...
plot(suksess, dbinom(suksess, size = 20, prob = .5),
     type = 'h',
...
plot(suksess,dbinom(suksess, size = 20, prob = .2),
     type = 'h',
