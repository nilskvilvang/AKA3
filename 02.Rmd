...
Hvis vi setter resultatet fra 6 000 000 terningkast inn i et søylediagram ser vi at resultatet er svært nærme hva vi teoretisk vil forvente:

```{r echo = FALSE, message = FALSE, warning=FALSE, fig.cap = "6 000 000 terningkast"}

hist(minterning,
     main="Søylediagram for 6 000 000 terningkast",
     ylab="Antall",
     xlab = "Verdi på terning",
     col = "lightblue")
```
...
alfabeta1 <- alphabeta(mean.sick=100, sd.sick=10, mean.healthy=250, 
         sd.healthy=15, cutoff=160, n=100000, do.plot=TRUE, 
         side="below")
alfabeta1
...
alfabeta2 <- alphabeta(mean.sick=100, sd.sick=10, mean.healthy=140, 
         sd.healthy=15, cutoff=120, n=100000, do.plot=TRUE, 
         side="below")
alfabeta2
```

I dette tilfellet er $\alpha$ = `r alfabeta2[1]` og $\beta$ = `r alfabeta2[2]`. Vi kan se i illustrasjonen at de skraverte områdene utgjør visualiseringen av hhv $\alpha$ og $\beta$ der det mørkeste grå området representerer $\alpha$ og det lysere grå $\beta$. 
...
alfabeta3 <- alphabeta(mean.sick=100, sd.sick=10, mean.healthy=140, 
         sd.healthy=15, cutoff=105, n=100000, do.plot=TRUE, 
         side="below")
alfabeta3
...
plot(plot.frame[1,] ~ cutoffs, type="l", las=1, 
     xlab="Cut-off verdi", ylab="Alfa/Beta", lwd=2, 
