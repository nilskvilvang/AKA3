...
<div align="center"> `r regresjonslikning3`.</div>
...
Analysen vår har gitt oss F verdien `r round(f_verdi, 3)` med `r p_verdi2`. Vi ser at verdien er statistisk signifikant. F verdien er et mål på forbedring i prediksjonen sett opp mot unøyaktigheter i modellen (alle modeller er unøyaktige (eller "feil")).
...
Her ser vi at p-verdien er `r round(heteroskedtest$p.value, 3)`, dvs. vi kan ikke forkaste nullhypotesen = vi har ikke grunn til å konkludere med at vi har heteroskedasisitet i regresjonsmodellen.
